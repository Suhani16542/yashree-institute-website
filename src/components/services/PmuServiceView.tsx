...
export default function PmuServiceView({ service }: ServiceViewProps) {
  return (
    <div className="space-y-0">
              ...
              <AnimatedReveal animation="fade-up" delay={400}>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                  ...
                  <div className="p-4 rounded-2xl bg-[#faf8f5] border border-amber-100 hover:border-amber-300 transition-colors col-span-2 sm:col-span-1">
                    <span className="text-[11px] text-zinc-500 font-medium block">Cartridges &amp; Inks</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="p-5 rounded-3xl bg-white border border-amber-100 shadow-sm">
              ...
              <p className="text-xs text-zinc-500 mt-1">Dedicated PMU Chair</p>
            </div>
            <div className="p-5 rounded-3xl bg-white border border-amber-100 shadow-sm">
              <Award className="w-5 h-5 text-[#b8860b] mb-2" />
              <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">Cartridges &amp; Inks</span>
              <h3 className="text-sm font-bold text-zinc-900 mt-1">{service.pricingInfo.kitInclusionValue}</h3>
              <p className="text-xs text-zinc-500 mt-1">Practice Materials Included</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <AnimatedReveal animation="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
              ...
              <p className="text-sm sm:text-base text-zinc-600 mt-1.5">
                From golden ratio brow mapping and silicone latex practice to ombre powder machine shading and Russian volume lash isolation.
              </p>
            </div>
          </AnimatedReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Golden Ratio &amp; Latex</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Ombre Brows &amp; Needles</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Lip Blush &amp; Neutralization</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Eyelash Extensions &amp; Fans</h3>
      ...
      {/* =========================================================================
          5. INTERACTIVE PMU GALLERY LIGHTBOX
         ========================================================================= */}
            ...
            <div className="lg:col-span-5 space-y-4 lg:sticky lg:top-24">
              <AnimatedReveal animation="fade-up">
                ...
                <p className="text-sm sm:text-base text-zinc-600 leading-relaxed">
                  Every PMU and lash topic covered with 100% hands-on practical focus, sterile cartridges, and individual feedback.
                </p>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-zinc-950 via-zinc-900 to-amber-950 p-6 sm:p-8 text-center text-white relative overflow-hidden shadow-2xl">
              <div className="relative z-10 max-w-2xl mx-auto space-y-4">
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-white">
                  Begin Your Professional PMU &amp; Lash Career
                </h3>
                <p className="text-xs sm:text-sm text-zinc-300">
                  Book your PMU station and get certified in semi-permanent makeup and eyelash extensions.
                </p>
