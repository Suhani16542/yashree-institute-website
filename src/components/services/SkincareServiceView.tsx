...
export default function SkincareServiceView({ service }: ServiceViewProps) {
  return (
    <div className="space-y-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="p-5 rounded-3xl bg-white border border-amber-100 shadow-sm">
              ...
              <p className="text-xs text-zinc-500 mt-1">Dedicated Spa Recliner</p>
            </div>
            <div className="p-5 rounded-3xl bg-white border border-amber-100 shadow-sm">
          ...
          <AnimatedReveal animation="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
              ...
              <p className="text-sm sm:text-base text-zinc-600 mt-1.5">
                From facial anatomy, clean-ups, and D-tan to body polish, Ayurvedic champi, and pedicure therapies.
              </p>
            </div>
          </AnimatedReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Skin Anatomy &amp; Clean-ups</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Facial Massage &amp; D-Tan</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Champi &amp; Body Polish</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Pedicure &amp; Waxing</h3>
      ...
      {/* =========================================================================
          5. INTERACTIVE SKINCARE GALLERY LIGHTBOX
         ========================================================================= */}
            ...
            <div className="lg:col-span-5 space-y-4 lg:sticky lg:top-24">
              <AnimatedReveal animation="fade-up">
                ...
                <p className="text-sm sm:text-base text-zinc-600 leading-relaxed">
                  Every skincare topic covered with 100% hands-on practical focus, real models, and individual feedback.
                </p>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-zinc-950 via-zinc-900 to-amber-950 p-6 sm:p-8 text-center text-white relative overflow-hidden shadow-2xl">
              <div className="relative z-10 max-w-2xl mx-auto space-y-4">
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-white">
                  Begin Your Professional Skin Care &amp; Spa Career
                </h3>
                <p className="text-xs sm:text-sm text-zinc-300">
                  Book your spa therapy bed and get hands-on training with professional products in Indore.
                </p>
