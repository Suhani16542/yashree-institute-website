...
export default function HairMasterclassServiceView({ service }: ServiceViewProps) {
  return (
    <div className="space-y-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="p-5 rounded-3xl bg-white border border-amber-100 shadow-sm">
              ...
              <p className="text-xs text-zinc-500 mt-1">Chemical Washing Station</p>
            </div>
            <div className="p-5 rounded-3xl bg-white border border-amber-100 shadow-sm">
              <Award className="w-5 h-5 text-[#b8860b] mb-2" />
              <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">Products Included</span>
              <h3 className="text-sm font-bold text-zinc-900 mt-1">{service.pricingInfo.kitInclusionValue}</h3>
              <p className="text-xs text-zinc-500 mt-1">Chemicals Provided for Practice</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <AnimatedReveal animation="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
              ...
              <p className="text-sm sm:text-base text-zinc-600 mt-1.5">
                From trichology and color wheels to botoplex treatments, rebonding chemistry, and precision sectioning.
              </p>
            </div>
          </AnimatedReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Trichology &amp; Diagnostics</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Color Wheels &amp; Balayage</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Keratin &amp; Rebonding</h3>
            ...
            <div className="p-6 rounded-3xl bg-[#faf8f5] border border-amber-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-bold text-zinc-900 mb-1">Precision Haircuts</h3>
      ...
      {/* =========================================================================
          5. INTERACTIVE HAIR MASTERCLASS GALLERY LIGHTBOX
         ========================================================================= */}
            ...
            <div className="lg:col-span-5 space-y-4 lg:sticky lg:top-24">
              <AnimatedReveal animation="fade-up">
                ...
                <p className="text-sm sm:text-base text-zinc-600 leading-relaxed">
                  Advanced chemical and precision haircutting modules taught with 100% hands-on practical focus and individual feedback.
                </p>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-zinc-950 via-zinc-900 to-amber-950 p-6 sm:p-8 text-center text-white relative overflow-hidden shadow-2xl">
              <div className="relative z-10 max-w-2xl mx-auto space-y-4">
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-white">
                  Begin Your Chemical Hair Artistry Career
                </h3>
                <p className="text-xs sm:text-sm text-zinc-300">
                  Book your workstation and master modern balayage, keratin, and precision haircuts in Indore.
                </p>
