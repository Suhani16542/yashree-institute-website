...
// 100% Curated, Procedural, High-Definition, Unwatermarked Photos for All 18 Courses
const masterImageManifest = [
  // ==========================================
  // 1. SKIN & ADVANCED AESTHETIC CARE
  // ==========================================
  // Hero: Aesthetician performing glowing clinical facial
  { file: 'skin_main.jpg', url: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=1200&auto=format&fit=crop' },
  // Step 1: Skin analysis & examination
  { file: 'skin_diag.jpg', url: 'https://images.unsplash.com/photo-1512290903671-1f48358482aa?q=80&w=1000&auto=format&fit=crop' },
  // Step 2: Enzyme peeling & brush prep
  { file: 'skin_machine.jpg', url: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?q=80&w=1000&auto=format&fit=crop' },
  // Step 3: Lymphatic drainage facial massage
  { file: 'skin_steam.jpg', url: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=1000&auto=format&fit=crop' },
  // Step 4: Clinical extraction / device therapy
  { file: 'skin_massage.jpg', url: 'https://images.unsplash.com/photo-1506152983158-b4a74a01c721?q=80&w=1000&auto=format&fit=crop' },
  // Step 5: Soothing face mask application
  { file: 'skin_mask.jpg', url: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=80&w=1000&auto=format&fit=crop' },
  // Step 6: Radiant luminous barrier skin
  ...
  // ==========================================
  { file: 'peel_main.jpg', url: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=1200&auto=format&fit=crop' },
  { file: 'peel_prep.jpg', url: 'https://images.unsplash.com/photo-1608248597359-00f074d2b27a?q=80&w=1000&auto=format&fit=crop' },
  { file: 'peel_apply.jpg', url: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?q=80&w=1000&auto=format&fit=crop' },
  { file: 'peel_neutral.jpg', url: 'https://images.unsplash.com/photo-1512290903671-1f48358482aa?q=80&w=1000&auto=format&fit=crop' },
  ...
  // ==========================================
  { file: 'bbglow_main.jpg', url: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?q=80&w=1200&auto=format&fit=crop' },
  { file: 'bbglow_infuse.jpg', url: 'https://images.unsplash.com/photo-1583001809873-a2254f9a463c?q=80&w=1000&auto=format&fit=crop' },
  { file: 'bbglow_needling.jpg', url: 'https://images.unsplash.com/photo-1607006314368-24570077977b?q=80&w=1000&auto=format&fit=crop' },
  ...
  { file: 'bbglow_finish.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 4. KOREAN GLASS SKIN & SPICULE FACIAL
  // ==========================================
  { file: 'korean_main.jpg', url: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'korean_glass_reveal.jpg', url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 5. HYDRA FACIAL & CLINICAL HYDRO-DERMABRASION
  // ==========================================
  { file: 'hydra_main.jpg', url: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'hydra_cold_hammer.jpg', url: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=80&w=1000&auto=format&fit=crop' },
  ...
  { file: 'hydra_cleanse.jpg', url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 6. HAIR CHEMICAL TREATMENTS & COLOR SCIENCE
  // ==========================================
  { file: 'chem_main.jpg', url: 'https://images.unsplash.com/photo-1600948836101-f9ffda59d250?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'hair_chem_foils.jpg', url: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?q=80&w=1000&auto=format&fit=crop' },
  ...
  // ==========================================
  { file: 'style_main.jpg', url: 'https://images.unsplash.com/photo-1560869713-7d0a29430803?q=80&w=1200&auto=format&fit=crop' },
  ...
  // ==========================================
  { file: 'cut_main.jpg', url: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?q=80&w=1200&auto=format&fit=crop' },
  ...
  // ==========================================
  { file: 'ext_main.jpg', url: 'https://images.unsplash.com/photo-1560869713-7d0a29430803?q=80&w=1200&auto=format&fit=crop' },
  { file: 'ext_sectioning.jpg', url: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=1000&auto=format&fit=crop' },
  ...
  { file: 'ext_tape_sandwich.jpg', url: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?q=80&w=1000&auto=format&fit=crop' },
  { file: 'ext_razor_blend.jpg', url: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?q=80&w=1000&auto=format&fit=crop' },
  { file: 'ext_volume_reveal.jpg', url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 10. PROFESSIONAL MAKEUP MASTERCLASS
  // ==========================================
  { file: 'pro_makeup_main.jpg', url: 'https://images.unsplash.com/photo-1487412912498-0447578fcca8?q=80&w=1200&auto=format&fit=crop' },
  { file: 'pro_makeup_brush.jpg', url: 'https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?q=80&w=1000&auto=format&fit=crop' },
  { file: 'pro_makeup_contour.jpg', url: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?q=80&w=1000&auto=format&fit=crop' },
  { file: 'pro_makeup_airbrush.jpg', url: 'https://images.unsplash.com/photo-1522337094846-8a818192de1f?q=80&w=1000&auto=format&fit=crop' },
  { file: 'pro_makeup_cutcrease.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1000&auto=format&fit=crop' },
  { file: 'pro_makeup_lips.jpg', url: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=1000&auto=format&fit=crop' },
  { file: 'pro_makeup_bridal.jpg', url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 11. SEMI-PERMANENT MAKEUP (SPMU)
  // ==========================================
  { file: 'spmu_main.jpg', url: 'https://images.unsplash.com/photo-1522337094846-8a818192de1f?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'spmu_healed_ombre.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 12. LIP NEUTRALIZING & PIGMENTATION
  // ==========================================
  { file: 'lipneut_main.jpg', url: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'lipneut_healed_pink.jpg', url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 13. LIP TINTING & VELVET BLUSH
  // ==========================================
  { file: 'liptint_main.jpg', url: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'liptint_blush_reveal.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 14. EYEBROW MICROBLADING & MICROSHADING
  // ==========================================
  { file: 'blade_main.jpg', url: 'https://images.unsplash.com/photo-1522337094846-8a818192de1f?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'blade_3d_brows.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 15. BEAUTY MOLE CREATION & SPOT ARTISTRY
  // ==========================================
  { file: 'mole_main.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'mole_calm_seal.jpg', url: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=80&w=1000&auto=format&fit=crop' },
  { file: 'mole_accent_reveal.jpg', url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 16. LASH LIFTING, KERATIN TINTING & BROW LAMINATION
  // ==========================================
  { file: 'lash_main.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'lash_keratin_oil.jpg', url: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=80&w=1000&auto=format&fit=crop' },
  { file: 'lash_curl_result.jpg', url: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 17. NAIL EXTENSIONS & SCULPTING (APPROVED)
  // ==========================================
  { file: 'nailext_main.jpg', url: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?q=80&w=1200&auto=format&fit=crop' },
  ...
  { file: 'nail_ext_hero.jpg', url: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?q=80&w=1000&auto=format&fit=crop' },

  // ==========================================
  // 18. NAIL ART & CREATIVE 3D DESIGNS (APPROVED)
  // ==========================================
  { file: 'nailart_main.jpg', url: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?q=80&w=1200&auto=format&fit=crop' },
  { file: 'nailart_000_brush.jpg', url: 'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?q=80&w=1000&auto=format&fit=crop' },
  ...
  { file: 'nailart_salon_set.jpg', url: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?q=80&w=1000&auto=format&fit=crop' }
];

async function run() {
  console.log('Downloading all procedural course step photos...');
  for (const item of masterImageManifest) {
  ...
  console.log('Finished updating course gallery images!');
}
